...
class Solution {
   public:
    ...
    // Most Optimal Sliding Window Approach(Using Frequency Arrays instead of Hashmaps)
    ...
    bool checkInclusion(string s1, string s2) {
        ...
        for (int i = 0; i < s2.size(); i++) {
            ...
            // If both frequency arrays match → permutation found
            if (freq1 == freq2)
                return true;
        }
